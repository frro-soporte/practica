...
.side-nav .heading .infoHome > h3 {
  margin: 0 0 5px;
}
.side-nav .heading .infoHome > h3 > a {
  color: #eee;
  font-weight: 100;
  margin-top: 4px;
  display: block;
...
.side-nav .heading .infoHome > h3 > a:hover {
  color: #fff;
}
.side-nav .heading .infoHome > p {
  color: #bbb;
  font-size: 13px;
}
/* End heading */
...
.statistics .box .infoHome {
  float: left;
  width: auto;
  margin-left: 10px;
}
.statistics .box .infoHome h3 {
  margin: 5px 0 5px;
  display: inline-block;
}
.statistics .box .infoHome p {
  color: #bbb;
}
...
.admins .box .infoHome h3 {
  font-size: 19px;
}
.admins .box .infoHome p {
  color: #bbb;
}
